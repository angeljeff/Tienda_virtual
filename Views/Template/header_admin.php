...
<html lang="es">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="Tienda Virtual Avicola lupe,avilupe ">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="kenny">
    <meta name="theme-color" content="#009688"> 
    <!--<meta name="theme-color" content="#EEA68C"> naranja-->
    <link rel="shortcut icon" href="<?= media();?>/images/favicon.ico">
    <title><?= $data['page_tag'] ?></title>

    <!-- agrega la libreria leaflet para el mapa  -->
    ...
    <link rel="stylesheet" type="text/css" href="<?= media(); ?>/css/distribucion.css">
  </head>
